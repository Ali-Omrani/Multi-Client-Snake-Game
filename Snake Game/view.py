...
this_is_heart_beat_rate_please_do_not_change_this_number_this_stupid_language_do_not_have_constant = 1
...
def draw_map():
    ...
    print "before read moving object of board"
    moving_object_of_board, changed = read_moving_object_of_board(client, None)
    print "after read moving object of board"
    screen = draw_initial_elements()
    print "after draw_initial_elements"
...
print "before reading board"
board = read_static_of_board(client)
print "after reading board - before drawing map"
draw_map()
print "after drawing map"
